    ...
    return (
        <div className="inner-common bg-g900">
            ...
            <p className="text-body-m px-[390px] text-g0">
                ...
                최상의 경험을 제공하는 솔루션을 추구합니다.
                디자인 경험을 바탕으로 직관적이고 접근성이
                뛰어난 UI를 정교하게 구현하며, 재사용성과
                유지보수를 고려한 체계적인 코드 구조를
                설계해 개발 과정에서부터 견고함과 효율성을
                보장합니다. 또한, 완성도 높은 결과물을 위해
                세세한 부분까지 철저히 검토하고 지속적으로
                개선하는 집요함을 발휘하며, 사용자의 입장을
                최우선으로 고려한 디자인 감각과 논리적인
                문제 해결 능력을 겸비한 개발자로서, 기술과
                미학 사이의 균형을 이뤄내기 위해 끊임없이
                도전합니다.
            </p>
        </div>
    );
